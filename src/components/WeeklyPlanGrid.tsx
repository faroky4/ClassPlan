    ...
    <div>
      <div className="no-print flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          <button className="btn-secondary" onClick={() => setWeekStart((w) => shiftWeekKey(w, -1))}>
            الأسبوع السابق
          </button>
          <button className="btn-secondary" onClick={() => setWeekStart(currentWeekStartKey())}>
            الأسبوع الحالي
          </button>
          <button className="btn-secondary" onClick={() => setWeekStart((w) => shiftWeekKey(w, 1))}>
            الأسبوع التالي
      ...
      {!loading && !error && data && (
        <div className="card mt-4 overflow-x-auto p-4 print:border-0 print:shadow-none">
